        ...
        <div class="container mx-auto p-6 max-w-2xl">
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight">Add New Child</h1>
                        <p class="text-muted-foreground mt-1">Add your child's information to book appointments</p>
                    </div>
                </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex gap-3 pt-4">
                                ...
                                <Button type="submit" class="flex-1" :disabled="form.processing">
                                    ...
                                    {{ form.processing ? 'Saving...' : 'Save Child' }}
                                </Button>
                            </div>
                        </form>
                    </CardContent>

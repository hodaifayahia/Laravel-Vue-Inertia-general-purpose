    ...
    <div id="smooth-content">
      <div class="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <section class="relative py-32 bg-gradient-to-b from-white to-indigo-50 dark:from-gray-800 dark:to-indigo-900/20 overflow-hidden">
          <!-- Background Elements -->
          <div class="absolute inset-0">
            <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-blue-200/20 to-purple-200/20 dark:from-blue-800/10 dark:to-purple-800/10 rounded-full blur-3xl animate-pulse"></div>
            <div class="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-emerald-200/20 to-teal-200/20 dark:from-emerald-800/10 dark:to-teal-800/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s"></div>
          </div>
          ...
          <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-6xl mx-auto">
              ...
              <div class="text-center mb-16">
                <div class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 backdrop-blur-sm rounded-full shadow-lg mb-8 border border-blue-200/50 dark:border-blue-800/50">
                  <Target class="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  <span class="text-lg font-medium text-gray-700 dark:text-gray-300">
                    {{ wTrans('welcome.assessment_title') }}
                  </span>
                </div>
                ...
                <p class="text-xl text-gray-600 dark:text-gray-400 reveal-text max-w-3xl mx-auto leading-relaxed">
                  {{ wTrans('welcome.assessment_description') }}
                </p>
              </div>

              <!-- Assessment Benefits -->
              <div class="grid md:grid-cols-3 gap-8 mb-16">
                <div class="stagger-item bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 border border-blue-100 dark:border-blue-800/50">
                  ...
                  <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ wTrans('welcome.benefit_early_detection') }}</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ wTrans('welcome.benefit_early_detection_desc') }}</p>
                </div>

                <div class="stagger-item bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 border border-emerald-100 dark:border-emerald-800/50">
                  ...
                  <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ wTrans('welcome.benefit_personalized_insights') }}</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ wTrans('welcome.benefit_personalized_insights_desc') }}</p>
                </div>

                <div class="stagger-item bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-3xl p-8 hover:shadow-2xl transition-all duration-300 border border-purple-100 dark:border-purple-800/50">
                  ...
                  <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ wTrans('welcome.benefit_expert_guidance') }}</h3>
                  <p class="text-gray-600 dark:text-gray-400">{{ wTrans('welcome.benefit_expert_guidance_desc') }}</p>
                </div>
              </div>

              <!-- Assessment Process -->
              <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-3xl p-8 md:p-12 mb-12 shadow-2xl border border-gray-200/50 dark:border-gray-700/50">
                <h3 class="text-3xl font-bold text-center text-gray-900 dark:text-white mb-8">
                  {{ wTrans('welcome.assessment_process_title') }}
                </h3>
                ...
                <div class="grid md:grid-cols-4 gap-8">
                  <div class="text-center fade-scale">
                    ...
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.process_step_1') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ wTrans('welcome.process_step_1_desc') }}</p>
                  </div>

                  <div class="text-center fade-scale">
                    <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                      <span class="text-2xl font-bold text-white">2</span>
                    </div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.process_step_2') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ wTrans('welcome.process_step_2_desc') }}</p>
                  </div>
                  ...
                  <div class="text-center fade-scale">
                    ...
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.process_step_3') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ wTrans('welcome.process_step_3_desc') }}</p>
                  </div>
                  ...
                  <div class="text-center fade-scale">
                    ...
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.process_step_4') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ wTrans('welcome.process_step_4_desc') }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div class="stagger-item bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-blue-100 dark:border-blue-800/50">
                  <div class="text-4xl mb-4">✏️</div>
                  <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.category_fine_motor') }}</h4>
                  <p class="text-sm text-gray-600 dark:text-gray-400">{{ wTrans('welcome.category_fine_motor_desc') }}</p>
                </div>

                <div class="stagger-item bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-emerald-100 dark:border-emerald-800/50">
                  <div class="text-4xl mb-4">🎯</div>
                  <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.category_spatial_awareness') }}</h4>
                  <p class="text-sm text-gray-600 dark:text-gray-400">{{ wTrans('welcome.category_spatial_awareness_desc') }}</p>
                </div>

                <div class="stagger-item bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-purple-100 dark:border-purple-800/50">
                  <div class="text-4xl mb-4">🧠</div>
                  <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.category_cognitive_processing') }}</h4>
                  <p class="text-sm text-gray-600 dark:text-gray-400">{{ wTrans('welcome.category_cognitive_processing_desc') }}</p>
                </div>

                <div class="stagger-item bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-orange-100 dark:border-orange-800/50">
                  <div class="text-4xl mb-4">📊</div>
                  <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ wTrans('welcome.category_visual_perception') }}</h4>
                  <p class="text-sm text-gray-600 dark:text-gray-400">{{ wTrans('welcome.category_visual_perception_desc') }}</p>
                </div>
              </div>

              <!-- Call to Action -->
              <div class="text-center fade-scale">
                <div class="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-8 md:p-12 shadow-2xl mb-8">
                  <h3 class="text-3xl md:text-4xl font-bold text-white mb-4">
                    {{ wTrans('welcome.assessment_cta') }}
                  </h3>
                  <p class="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                    {{ wTrans('welcome.assessment_cta_subtext') }}
                  </p>

                  <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      href="/assessment"
                      class="inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-900 rounded-full font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 transform hover:-translate-y-1"
                    >
                      <Target class="w-6 h-6" />
                      <span>{{ wTrans('welcome.assessment_cta') }}</span>
                      <ChevronRight class="w-6 h-6" />
                    </Link>

                    <Link
                      href="/about"
                      class="inline-flex items-center gap-3 px-8 py-4 bg-white/20 text-white border-2 border-white/30 rounded-full font-bold text-lg hover:bg-white/30 hover:shadow-xl transition-all duration-300"
                    >
                ...
                <!-- Trust Indicators -->
                <div class="flex flex-wrap justify-center items-center gap-8 text-gray-600 dark:text-gray-400">
                  <div class="flex items-center gap-2">
                    <Shield class="w-5 h-5 text-green-500" />
                    <span class="text-sm">{{ wTrans('welcome.assessment_trust_badges') }}</span>
                  </div>
                </div>
              </div>
            </div>

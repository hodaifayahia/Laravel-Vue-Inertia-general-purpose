...
import { Calendar, Clock, MapPin, User, Stethoscope, CheckCircle2, Award, Smile, Frown, ArrowRight, ArrowLeft, ChevronDown, Building2 } from 'lucide-vue-next'
...
<template>
  <AppLayout>
    <Head title="حجز موعد - Book Appointment" />
    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div class="mb-8 text-center">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-400">
          Book an Appointment with a Dysgraphia Specialist
        </p>
      </div>
